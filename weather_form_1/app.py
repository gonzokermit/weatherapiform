...
def result():
    ...
    try:
        ...
        return render_template("/result.html", date_time=date_time,city_name=city_name,country=country,description=description,temp=temp,humidity=humidity,wind=wind)
    except KeyError:
        return render_template("/error.html")
